...
public class ResumeDao {
	 ...
	 * @return
	 */
	public boolean getResumeByUserId(long user_id,long resume_id){
		//执行模板函数
		ResumeDaoGetResumeByUserIdImpl resumeDaoGetResumeByUserIdImpl = new ResumeDaoGetResumeByUserIdImpl(user_id, resume_id);
	 ...
	 * @return
	 */
	public boolean deleteResume(long user_id,long resume_id){
		//执行模板函数
		ResumeDaoDeleteResumeImpl resumeDaoDeleteResumeImpl = new ResumeDaoDeleteResumeImpl(user_id, resume_id);
