...
import com.nupt.core.tools.HibernateSessionFactory;
...
public class CoreDao {
	 ...
	 */
	public List<Object[]> queryCustomListByHql(String hql){
	 ...
	 */
	public <T> T queryUniqueById(long id,String entityName){
	 ...
	 * @param id 需要删除的记录的id
	 */
	public <T> boolean deleteUniqueById(long id,String entityName){
		if(id<=0 || entityName==null || "".equals(entityName)){
			return false;
		}
